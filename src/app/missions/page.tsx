        ...
        <div className="min-h-screen bg-void-black text-stark-white font-mono p-6">
            ...
            <div className="max-w-6xl mx-auto mb-8">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="font-display text-4xl md:text-6xl tracking-wider mb-2">MISSION'LAR</h1>
                        <p className="text-silver/60 text-sm">Büyük projeler, güçlü squad'lar gerektirir</p>
                    </div>
                </div>
